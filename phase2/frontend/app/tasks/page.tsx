...
function StatCard({ label, value, variant, icon }: StatCardProps) {
  const variants = {
    ...
    success: {
      bg: 'bg-success-50/50 dark:bg-success-950/30',
  ...
  return (
    <div className={`rounded-xl p-4 border ${style.bg} ${style.border} transition-all duration-200 hover:shadow-sm dark:hover:shadow-none`}>
